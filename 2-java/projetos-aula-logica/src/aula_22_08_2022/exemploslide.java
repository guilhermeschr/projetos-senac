package aula_22_08_2022;

import java.util.Scanner;

public class exemploslide {
    public static void main(String[] args) {
        ...
        System.out.println("Numero de letras da palavra:");
        System.out.println(palavra.length()+"\n");

        System.out.println("Todas as caracteres maiusculas:");
        System.out.println(palavra.toUpperCase()+"\n");

        System.out.println("Numero de vogais:");
        int tampanhopalavra = palavra.length();
        String partes []= new String[tampanhopalavra];
